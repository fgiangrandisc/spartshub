/* ═══════════════════════════════════════════════════════════════
   PORTALMAQUINAS — UNIFIED DESIGN SYSTEM
   Dark industrial. Bebas Neue headings. Barlow body.
   Primary: #FF6A00  |  Trust: #3B82F6  |  Success: #22C55E
═══════════════════════════════════════════════════════════════ */

export const T = {
  RED:    "#FF6A00",   // Primary action
...
.btn-ol:hover{border-color:#FF6A00;color:#FF6A00}
...
.card:hover{border-color:rgba(255,106,0,.3)}
...
.t-red{background:rgba(255,106,0,.12);color:#FF6A00;border:1px solid rgba(255,106,0,.25)}
...
/* Spinner */
.spinner{border:2.5px solid rgba(48,58,70,.6);border-top-color:#FF6A00;border-radius:50%;animation:spin .7s linear infinite}
...
.seg-btn.active{background:#FF6A00;color:#fff}
...
.sidebar-btn.active{background:rgba(255,106,0,.1);color:#FF6A00;font-weight:700;border-left-color:#FF6A00}
